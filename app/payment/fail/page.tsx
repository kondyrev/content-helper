  ...
  return (
    <main className="min-h-screen bg-black px-6 py-16 text-white">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-red-300/30 bg-red-300/10 text-3xl">
          ×
        </div>
        ...
        <p className="mt-4 text-lg text-gray-400">
          Платёж был отменён или не прошёл. Деньги не списаны, тариф не изменён.
        </p>
